...
class TestEventDrivenFlow:
    ...
    def test_single_event_matches_single_policy(self, _mock_azure_events):
        """
    ...
    def test_single_event_matches_multiple_policies(self, _mock_azure_events):
        """
        単一イベント → 複数ポリシーにマッチ
    ...
    def test_event_matches_no_policy(self, _mock_azure_events):
        """
        イベント → どのポリシーにもマッチしない
        ...
        # 異なる操作名のイベント
        event = create_event_grid_event(operation_name="Microsoft.Compute/virtualMachines/write")
    ...
    def test_event_selective_matching(self, _mock_azure_events):
        """
    ...
    def test_push_execution_failure_is_recorded(self, _mock_azure_events):
        """
...
class TestQueueMessageDecoding:
    ...
    def test_full_queue_to_execution_flow(self, _mock_azure_events):
        """
...
class TestEventParsing:
    ...
    def test_parsed_event_properties(self):
        ...
        assert (
            parsed.resource_provider == "Microsoft.Storage/storageAccounts/blobServices/containers"
        )
